...
namespace tidy {
namespace dkaq {
class DefineValueKeywordCheck : public DkaqClangTidyCheck {
public:
...
private:
  ...
  public:
    DefineValueKeywordPPCallbacks(DefineValueKeywordCheck *Check)
        : Check(Check) {}
    ...
    void MacroDefined(const Token &MacroNameTok,
      ...
      for (const Token &Tok : MI->tokens()) {
        StringRef TokenText =
            Tok.getIdentifierInfo() ? Tok.getIdentifierInfo()->getName() : "";
